...
```
cd existing_repo
git remote add origin https://gitlab.com/yusufshaidu/ml-potentials.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/yusufshaidu/ml-potentials/-/settings/integrations)
